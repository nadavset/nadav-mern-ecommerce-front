...
const Shop = () => {
    ...
    const [brands, setBrands] = useState(["Apple", "Dell", "Microsoft", "Lenovo", "ASUS"]);
            ...
            <div className="row">
                <div className="col-md-3 pt-2 text-right">
                    ...
                    <Menu defaultOpenKeys={['1', '2', '3', '4', '5', '6', '7']} mode="inline">
                        ...
                        <SubMenu
                            key='1'
                            title={<span className="h6"><DollarOutlined />מחיר</span>
                            }>
                            <div>
                                <Slider
                                    className="ml-4 mr-4"
                        ...
                        <SubMenu
                            key='2'
                            title={<span className="h6"><DownSquareOutlined />קטגוריות</span>
                            }>
                            <div >
                        ...
                        <SubMenu
                            key='3'
                            title={<span className="h6"><StarOutlined />דירוג</span>
                            }>
                            <div >
                        ...
                        <SubMenu
                            key='4'
                            title={<span className="h6"><DownSquareOutlined />קטגוריית משנה</span>
                            }>
                            <div >
                        ...
                        <SubMenu
                            key='5'
                            title={<span className="h6"><DownSquareOutlined />חברה</span>
                            }>
                            <div >
                        ...
                        <SubMenu
                            key='6'
                            title={<span className="h6"><DownSquareOutlined />צבע</span>
                            }>
                            <div >
                        ...
                        <SubMenu
                            key='7'
                            title={<span className="h6"><DownSquareOutlined />משלוח</span>
                            }>
                            <div >
                ...
                <div className="col-md-9 pt-2">
                    {loading ? (
                        <h4 className="text-danger">עמוד בטעינה...</h4>
                    ) : (
                        <h4 className="text-danger">מוצרים</h4>
                    )}

                    {products.length < 1 && <p>לא נמצאו מוצרים</p>}
